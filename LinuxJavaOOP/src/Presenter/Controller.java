...
public class Controller {
    ...
    public void button_click() {
        ...
        String fileNomeclatureAddress = "src/SystemData/SavedNomenclature.csv";
        String fileQueueAddress = "src/SystemData/Queue.csv";
        String givenOutToysAddress = "src/UserData/GivenOutToys.txt";
